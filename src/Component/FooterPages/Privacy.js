...
export default function PrivacyPolicy() {
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Healing Garden India</title>
        <meta
          name="description"
          content="Please read through our privacy policy."
        />
        <meta
          name="keywords"
          content="privacy policy, healing garden, data protection"
        />
        <meta
          property="og:title"
          content="Privacy Policy | Healing Garden India"
        />
        <meta
        ...
        <link
          rel="canonical"
          href="http://www.healinggarden.co.in/privacy-policy"
        />
      </Helmet>
      <Header />
      <Mobileheader />
      <div className="categoryview m-auto row">
        ...
        <div className="row m-auto ">
          <div className="d-flex p-3 ">
            ...
            <li className="headertext">
              <a className="headertext" href="/privacy">
                {" "}
                Privacy Policy
              </a>
            </li>
      ...
      <div className="container  m-auto p-4">
        <div className="row text-center">
          <h1 className="m-auto heading mb-3 mt-3">Privacy Policy</h1>
        </div>
        <p className="sub_heading fs-3">Introduction </p>
        <p className="sub_sub_heading">
          This Privacy Policy describes how <strong>HEALING GARDEN</strong> and
          its affiliates (collectively <strong> "HEALING GARDEN</strong>, we,
          our, us") collect, use, share, protect or otherwise process your
          information/ personal data through our website{" "}
          <strong> www.healinggarden.co.in</strong> (hereinafter referred to as
        ...
        <p className="sub_sub_heading">
          ...
          course of our relationship.and related information provided from time
          to time. Some of the information that we may collect includes but is
          not limited to personal data / information provided to us
        </p>
        <p className="sub_sub_heading">
          during sign-up/registering or using our Platform such as name, date of
          ...
          <strong> HEALING GARDEN </strong>seeking any personal data like
        ...
        <p className="sub_sub_heading">
          ...
          by them. These entities and affiliates may market to you as a result
          of such sharing unless you explicitly opt-out. We may disclose
          personal data to third parties such as sellers, business partners,
          third party service providers including logistics partners, prepaid
          payment instrument issuers, third-party reward programs and other
          payment opted by you. These disclosure may be required for us to
          provide you access to our services and products offered to you, to
          ...
          or others in the good faith belief that such disclosure is reasonably
        ...
        <p className="sub_sub_heading">
          ...
          reasonable security practices and procedures. Once your information is
          in our possession or whenever you access your account information, we
          adhere to our security guidelines to protect it against unauthorised
          access and offer the use of a secure server. However, the transmission
          of information is not completely secure for reasons beyond our
          control. By using the Platform, the users accept the security
        ...
        <p className="sub_sub_heading">
          ...
          in event of any pending grievance, claims, pending shipments or any
          ...
          your personal data information for a period no longer than is required
          for the purpose for which it was collected or as required under any
        ...
        <p className="sub_sub_heading">
          <strong>Your Rights-</strong> You may access, rectify, and update your
          personal data directly through the functionalities provided on the
          Platform.
        </p>
        <p className="sub_sub_heading">
          <strong>Consent-</strong> By visiting our Platform or by providing
          ...
          have the authority to do so and permit us to use the information in
          ...
          instant messaging apps, call and/or e-mail for the purposes specified
          in this Privacy Policy. You have an option to withdraw your consent
          that you have already provided by writing to the Grievance Officer at
          the contact information provided below. Please mention “Withdrawal of
          ...
          request. However, please note that your withdrawal of consent will not
          ...
          given to us under this Privacy Policy, we reserve the right to
          restrict or deny the provision of our services for which we consider
        ...
        <p className="sub_sub_heading">Contact us: 96205 20200</p>
        <p className="sub_sub_heading">
          Phone: Time: Monday - Friday (9:00 AM - 6:00 PM)
        </p>
      </div>
      <Footer />
      <Mobilefooter />
